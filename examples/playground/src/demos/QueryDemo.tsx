      ...
      <div class="section">
        ...
        <div class="field">
          ...
          <input
            ...
            value={nameInput()}
            onInput={(e: Event) =>
              nameInput.set((e.target as HTMLInputElement).value)
            }
          />
        </div>
        <div class="field">
          ...
          <input
            ...
            value={emailInput()}
            onInput={(e: Event) =>
              emailInput.set((e.target as HTMLInputElement).value)
            }
          />
        </div>
        <button
          ...
          onClick={() =>
            mutation.mutate({ name: nameInput(), email: emailInput() })
          }
        >
...
export function QueryDemo() {
  return (
    <div>
      <h2>Query</h2>
      <p class="desc">
        TanStack Query adapter. Reactive data fetching with caching, mutations,
        and invalidation.
      </p>
