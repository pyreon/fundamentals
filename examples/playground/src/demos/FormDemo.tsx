...
import { useForm, useField, useFormState } from '@pyreon/form'
...
export function FormDemo() {
  ...
  return (
    <div>
      <h2>Form</h2>
      <p class="desc">
        Signal-based form management with field validation, submission, and
        reactive state.
      </p>
        ...
        <form onSubmit={(e: Event) => form.handleSubmit(e)}>
          ...
          <div class="field">
            <label>
              <input
                type="checkbox"
                {...form.register('newsletter', { type: 'checkbox' })}
              />{' '}
