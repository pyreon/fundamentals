...
export function StoreDemo() {
  ...
  return (
    <div>
      <h2>Store</h2>
      <p class="desc">
        Global state management with composition stores. Signals, computed,
        actions, patch, subscribe, reset.
      </p>
      ...
      <div class="section">
        ...
        <pre style="font-size: 13px">
          {() => JSON.stringify(useCounter().state, null, 2)}
        </pre>
      </div>
      ...
      <div class="section">
        ...
        <div class="log">
          {() =>
            log().length === 0
              ? 'No mutations yet. Click a button above.'
              : log().join('\n')
          }
        </div>
      </div>
