...
export function ChartDemo() {
  ...
  return (
    <div>
      <h2>Charts</h2>
      <p class="desc">
        Reactive ECharts bridge with lazy loading. Zero ECharts bytes until a
        chart renders — modules are auto-detected and dynamically imported.
        Signal reads inside options functions trigger reactive updates.
      </p>
      ...
      <div class="section">
        ...
        <div class="log">
          {() =>
            log().length === 0
              ? 'Interact with the charts above to see changes.'
              : log().join('\n')
          }
        </div>
      </div>
