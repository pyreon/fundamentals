    ...
    <div>
      ...
      <div class="section">
        ...
        <p style="font-size: 13px; opacity: 0.7; margin-top: 4px">
          Buttons auto-disable based on <code>machine.can(event)</code> — no
          manual disabled logic needed.
        </p>
      </div>
          ...
          if (guardedForm.matches('editing'))
            return (
              <div>
                ...
                <button onClick={() => guardedForm.send('SUBMIT')}>
                  Submit
                </button>
                <p style="font-size: 13px; opacity: 0.7; margin-top: 4px">
                  {() =>
