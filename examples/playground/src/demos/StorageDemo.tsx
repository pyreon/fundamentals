    ...
    <div>
      ...
      <div class="section">
        ...
        <p style="margin-bottom: 8px">
          Step <strong>{() => wizardStep()}</strong> of 4 (tab-scoped, lost on
          close)
        </p>
        <div class="row">
          <button
      ...
      <div class="section">
        ...
        <p>
          Current: <strong>{() => locale()}</strong> (persists as cookie with
          1-year expiry)
        </p>
      </div>
      ...
      <div class="section">
        ...
        <input
          ...
          value={tempNote()}
          onInput={(e: Event) =>
            tempNote.set((e.target as HTMLInputElement).value)
          }
      ...
      <div class="section">
        ...
        <p>
          Same key returns same signal:{' '}
          <strong>{isSameInstance ? 'true' : 'false'}</strong>
        </p>
        <p style="font-size: 13px; opacity: 0.7">
          Calling <code>useStorage('playground-theme', 'light')</code> twice
          returns the exact same signal instance — no drift between components.
        </p>
      </div>
